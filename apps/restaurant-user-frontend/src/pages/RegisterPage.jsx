...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create a payload that includes 'name' for backend compatibility
      const payload = {
        ...form,
        name: form.fullName
      };
      ...
      // If auto-login is supported by your backend
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans selection:bg-[#d05322] selection:text-white">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-[#111827] overflow-hidden">
        {/* Beautiful, upscale restaurant dining room focused on the table/food setting */}
        <img 
        ...
        <div className="absolute bottom-16 left-12 right-12 text-white z-10">
          <h2 className="text-[40px] font-extrabold tracking-tight mb-4 leading-tight drop-shadow-lg">
            Join the <br/><span className="text-[#d05322]">Culinary Elite.</span>
          </h2>
          <p className="text-[16px] text-gray-300 font-medium max-w-md leading-relaxed drop-shadow-md">
            Whether you are a discerning guest or a passionate restaurateur, your premium dining journey starts here.
          </p>
        </div>
      </div>

      {/* RIGHT PANEL - Minimalist Registration Form */}
        ...
        <div className="w-full max-w-[420px] py-12">
          ...
          <div className="mb-10">
            ...
            <p className="text-[15px] text-gray-500 font-medium">
              Enter your details to join Digital Maitre D'.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-start gap-3 ml-1 mt-6">
              ...
              <label htmlFor="agreed" className="text-[13px] font-medium text-gray-500 cursor-pointer select-none leading-snug">
                I agree to the <span className="text-[#1f2937] font-bold">Terms of Service</span> and <span className="text-[#1f2937] font-bold">Privacy Policy</span>.
              </label>
            </div>
          ...
          <div className="mt-10 text-center">
            <p className="text-[14px] text-gray-500 font-medium">
              ...
              <Link to="/login" className="font-bold text-[#d05322] hover:text-[#b84318] transition-colors underline decoration-2 underline-offset-4">
                Sign in
              </Link>
            </p>
          </div>
