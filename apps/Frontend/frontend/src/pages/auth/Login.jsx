...
export default function Login() {
  ...
  const [roleMode, setRoleMode] = useState('CUSTOMER'); // Toggle between CUSTOMER and OWNER
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Sending email and password to your Spring Boot backend
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#eaeaea] p-4">
      <div className="bg-white p-10 rounded-[2rem] shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" className="w-full bg-brand-orange text-white font-bold py-4 rounded-xl hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/30 mt-4 flex justify-center items-center gap-2">
            Sign In 
        ...
        <div className="flex gap-4 mt-6">
          <button className="flex-1 border border-gray-200 py-3 rounded-xl font-bold text-gray-700 hover:bg-gray-50 transition-colors flex justify-center items-center gap-2">
            Google
          </button>
          <button className="flex-1 border border-gray-200 py-3 rounded-xl font-bold text-gray-700 hover:bg-gray-50 transition-colors flex justify-center items-center gap-2">
            Apple
